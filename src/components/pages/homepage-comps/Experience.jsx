      ...
      <div className="experience-container">
        ...
        <div className={`experience-box ${activeCard === 'verusen' ? 'popped-out' : ''}`} onClick={() => handleCardClick('verusen')}>
          ...
          <div className="experience-content">
            <h2 className="text-2xl font-semibold ">Verusen</h2>
            <p className="text-lg mt-2 text-gray-400">Data Analyst Research Intern</p>
            <span className="text-gray-400 block mt-2">May 2024 - August 2024, Atlanta, USA</span>
            {activeCard === 'verusen' && (
              <p className="mt-4">
        ...
        <div className={`experience-box ${activeCard === 'buffalo' ? 'popped-out' : ''}`} onClick={() => handleCardClick('buffalo')}>
          ...
          <div className="experience-content">
            <h2 className="text-2xl font-semibold">University at Buffalo</h2>
            <p className="text-lg mt-2 text-gray-400">Graduate Student Assistant</p>
            <span className="text-gray-500 block mt-2">Jan 2024 - May 2024, New York, USA</span>
            {activeCard === 'buffalo' && (
              <p className="mt-4">
        ...
        <div className={`experience-box ${activeCard === 'tcs' ? 'popped-out' : ''}`} onClick={() => handleCardClick('tcs')}>
          ...
          <div className="experience-content">
            <h2 className="text-2xl font-semibold">Tata Consultancy Services</h2>
            <p className="text-lg mt-2 text-gray-400">Data Engineer (General Electric Healthcare)</p>
            <span className="text-gray-500 block mt-2">July 2019 - July 2023, Bangalore, India</span>
            {activeCard === 'tcs' && (
              <p className="mt-4">
