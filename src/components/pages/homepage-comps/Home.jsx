...
const Home = () => {
    return (
        <section name="Home" className="relative w-full h-screen overflow-y-auto">
            <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-0 md:flex-row md:gap-8">
                <div className="flex flex-col justify-center items-center h-[85%] md:h-full order-2 md:order-1 md:items-start">
                    <h1 className="text-4xl md:text-6xl font-bold text-white mb-2 mt-3 md:mt-0 md:mb-4">I'm Anusha Udayakumar</h1>
                    <h2 className="rounded-md bg-primary-color/20 max-w-max px-6 inline text-xl md:text-3xl lg:text-4xl font-semibold text-white">Full Stack Developer</h2>
                    <p className="text-gray-300 py-4 max-w-md text-justify">
                        Certified by Platzi, one of the largest online professional education platforms in Latin America, and by Academlo, where I graduated as a Full Stack developer with JavaScript. Welcome to my portfolio, I'm excited to share my journey with you!
                    </p>
